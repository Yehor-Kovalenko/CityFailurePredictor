...
export function TopBar({
    ...
    return (
        <div
            className="relative z-[9999] bg-gradient-to-r from-dark-800 to-dark-800 border-b border-dark-700 px-6 py-4 flex items-center justify-between">
            ...
            <div className="flex items-center gap-4 ml-6">
                <div
                    className="hidden lg:flex flex-col items-end px-3 py-1 rounded-lg bg-dark-700 border border-dark-600">
                    <span className="text-xs text-dark-300">{userEmail}</span>
                    <span className="text-xs text-blue-400">{userRole}</span>
                </div>

                <div
                    className="flex items-center gap-1 px-3 py-1 bg-yellow-500/20 text-yellow-500 rounded-lg text-sm font-medium">
